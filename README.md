...
本利用規約（以下、本規約）は、PJWorld（以下、管理者）が本ウェブサイト上に提供するサービス（本サービス）の利用要件を定めるものです。登録者の皆様（以下、ユーザー）には、利用にあたり本規約に同意していただく必要がございます。
...
5 項.  投稿・利用者は、公式の承認・保証を受けていないことを理解したうえで利用するものとします。

6 項.  本サービスは、プロセカ公式が定める二次創作・コミュニティ活動のガイドラインに従う必要があります。
...
代表　 ゆんふぃ 　連絡先　misskey@pjsekai.world (必ず連絡がつく情報を記載)
