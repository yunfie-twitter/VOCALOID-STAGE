...
本利用規約（以下、本規約）は、VOC@LOID ST@GE（以下、管理者）が本ウェブサイト上に提供するサービス（本サービス）の利用要件を定めるものです。登録者の皆様（以下、ユーザー）には、利用にあたり本規約に同意していただく必要がございます。
...
14.　保護者に許可を得ていない未成年者による本サービスの利用
...
4 項.  本サービスは、株式会社セガ及び株式会社Colorful Paletteが提供する「プロジェクトセカイ カラフルステージ！」とは一切関係がありません。

5 項.  本サービスは、クリプトン・フューチャー・メディア（株）及びヤマハ株式会社とは一切関係がありません。

6 項.  投稿・利用者は、公式の承認・保証を受けていないことを理解したうえで利用するものとします。

7 項.  本サービスは、権利元が定める二次創作・コミュニティ活動のガイドラインに従う必要があります。
...
2 項.　本サービスに関して紛争が発生した場合には管理人の所在地である裁判所を専属的合意管轄とします。
